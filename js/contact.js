  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (scrollContainer && formContainer && messageTextarea && submitButton) {
      scrollContainer.addEventListener("click", function (event) {
        ...
        messageTextarea.classList.remove("center-placeholder");
    ...
    function animateRoll(timestamp, animParams) {
      ...
      const scrollContent = scrollElement.querySelectorAll(
        "h2, .form-container"
      );
      let opacityProgress;
        ...
        if (finalParchmentIsRolled === true && isRolled === false) {
          ...
          setTimeout(function () {
            ...
            const unrollAnimParams = {
              ...
              startClipLeft: currentScrollWidth - 50,
              targetClipLeft: 50,
    ...
    rollButton.addEventListener("click", function () {
      ...
      const rollUpAnimParams = {
        ...
        startClipLeft: 50,
        targetClipLeft: currentScrollWidth - 50,
        duration: animationDuration,
